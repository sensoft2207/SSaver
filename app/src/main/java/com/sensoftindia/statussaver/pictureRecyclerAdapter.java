...
public class pictureRecyclerAdapter extends RecyclerView.Adapter<pictureRecyclerAdapter.MyViewHolder> {
    private static String DIRECTORY_TO_SAVE_MEDIA_NOW = "/storage/emulated/0/Status Saver/Status Pictures/";
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Snackbar snackbar;
                snackbar = Snackbar.make(view, "Picture Downloaded Successfully", Snackbar.LENGTH_LONG);
